      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sr-input {
          ...
          border-radius: 8px; padding: 12px 18px; font-size: 15px;
        ...
        .sr-genre {
          ...
          padding: 3px 8px; font-size: 10px; color: var(--muted);
        }
        ...
        .sr-detail {
          ...
          grid-template-columns: 200px 1fr 280px; gap: 28px;
          align-items: start;
        }
        ...
        .sr-detail-cover-placeholder {
          width: 200px; height: 260px; background: var(--surface2);
